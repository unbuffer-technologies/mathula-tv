...
TIKTOK_EDIT_RENDER_VERSION = "mathula-tiktok-publication-render-v26-local-editorial-text-authority-final-quality-v13.15.1"
    ...
    response = provider.complete_structured(
        StructuredAIRequest(
            ...
            payload={
                ...
                "complete_english_transcript": dict(english_transcript or {}),
...
def render_tiktok_hook_edit(
    *,
    ...
    if apply_opening_cut and cut_seconds > 0:
        command.extend(["-ss", f"{cut_seconds:.6f}"])
    command.extend([
        "-i",
        str(master_video),
        "-i",
