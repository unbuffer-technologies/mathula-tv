...
COMPACT_MULTIVARIANT_WIRE_SCHEMA_VERSION = "mathula.translation.multivariant.compact-wire.v1"
...
Return every requested unit exactly once and in request order. This compact wire
contract supersedes earlier instructions to repeat source fields or the full
Mathula translation envelope. Return JSON only.
"""
...
def _canonicalize_compact_multivariant_wire(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    for raw_unit in raw_units:
        ...
        allowed_unit = {"id", "f", "o", "n", "c", "k"} | _COMPACT_HARMLESS_ANNOTATION_KEYS
        ...
        for short_key, variant_name in variant_specs:
            ...
            if not isinstance(raw_variant, Mapping):
                ...
                continue
            allowed_variant = {"t", "ms", "p", "o", "ok"} | _COMPACT_HARMLESS_ANNOTATION_KEYS
        ...
        *,
        ...
        if self.provider == PRODUCTION_AI_PROVIDER and request.provider_json_schema:
            output_config["format"] = {
                "type": "json_schema",
                "schema": _anthropic_output_schema(wire_schema),
            }
